export const vocab = [
  ...
  {
    kana: 'あれ',
    meaning: 'that over there (away from speaker and listener)',
  },
  {
    kana: 'ざっし',
  ...
  {
    kana: 'じしょ',
    meaning: 'dictionary (more common)',
  },
  {
    kana: 'あの',
  ...
  {
    kana: 'この',
    meaning: 'this (+ noun) (close to the speaker)',
  },
  {
    kana: 'スイス',
    meaning: 'Switzerland',
...
export default { name: 'Unit 2', id: 'unit2', vocab };
